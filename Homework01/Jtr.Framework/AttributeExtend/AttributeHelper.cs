...
namespace Jtr.Framework.AttributeExtend
{
    public static class AttributeHelper
    {
        ...
        //public static string GetDispayName(this PropertyInfo prop)
        //{

        //    if (prop.IsDefined(typeof(DisplayAttritube), true))
        //    {
        //        DisplayAttritube attribute = (DisplayAttritube)prop.GetCustomAttribute(typeof(DisplayAttritube), true);
